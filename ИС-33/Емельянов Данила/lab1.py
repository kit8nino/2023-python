...
data = ("Емельянов Данила Владимирович", 26, 2, 2004)
subject = {
"Англ. яз." : 5,
"Физика" : 5,
"Русский язык" : 5,
...
relatives = ["Анастасия", "Ирина", "Арина", "Наталья", "Ирина"]
nickname = "Кеша"
...
number2 = len("ЕмельяновДанилаВладимирович") * len_family_names % 4
...
print("№8", FIFO())
print("№9.1", "Номер, получаемый из моей даты рождения для Ирины: ", number1)

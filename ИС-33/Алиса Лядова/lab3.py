...
# Read the maze from the "maze-for-u1.txt" file and create a maze list
...
maze = read_maze("maze-for-u1.txt")
height = len(maze)
width = len(maze[0])
passages = []
...
# Create the "resuult1.txt" file
def main():
    filename = "maze-for-u1.txt"

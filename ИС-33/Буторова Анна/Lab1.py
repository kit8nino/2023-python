...
my_tuple = ("Буторова Анна Андреевна", 29, 6, 2004)
...
my_list = ["Светлана", "Екатерина", "Диана", "Сергей", "Галина", "Жанна", "Павел", "Дмитрий", "Алексей", "Андрей", "Виктор", "Карина",
           "Михаил", "Петра", "Саша"]
...
def get_unique_words(my_list):
    ...
    list_of_unique_words.append("Anna")
...
DR = datetime.datetime(2004, 6, 29)
d = now - DR
print('7.Я прожила: {} дней.'.format(d.days))
